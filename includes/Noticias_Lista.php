   ...
   if($row_Consulta_uno['strPosicion'] == "1"){ ?>
               ...
               <div class="homepost small-image-right">
                 ...
                 <!-- 
                    ...
                    <a href="detallados.php?recordID=<?php echo $row_Consulta_uno['idEntradas']; ?>" rel="bookmark"><img width="660" height="413" src="imagen/noticias/<?php echo $row_Consulta_uno['strImagen']; ?>" class="attachment-big-image-center wp-post-image" alt="." title="<?php echo $row_Consulta_uno['strTitulo']; ?>"></a></div>
                    <br><br><br>
...
<!-- ----------------dos	------------ -->	  
   ...
   if($row_consulta_dos['strPosicion'] == "2"){ ?>
        ...
        -->
            ...
            <div class="content-image"><a href="detallados.php?recordID=<?php echo $row_consulta_dos['idEntradas']; ?>" rel="bookmark"> <img width="680" height="413" src="imagen/noticias/<?php echo $row_consulta_dos['strImagen']; ?>" class="attachment-big-image-center wp-post-image" alt="." title="<?php echo $row_consulta_dos['strTitulo']; ?>"></a></div>
            ...
            <div class="content-area" style=" text-align:justify;"><p><?php echo substr($row_consulta_dos['strContenido'],0,500); ?></p> 
              </div>
            <div class="cb"></div>
            </div>
...
<!-- --------------- tres --------------- -->
   ...
   if($row_consulta_tres['strPosicion'] > "0") { ?>
       ...
       <?php if(isset($row_consulta_tres['strImagen'])){ ?>
         ...
         <div class="meta"><div class="readmore"><a href="detallados.php?recordID=<?php echo $row_consulta_tres['idEntradas']; ?>">Continue Leyendo</a></div>
         <div class="categoria"><a href="categorias.php?recordID=<?php echo $row_consulta_tres['strCategorias']; ?>" title="<?php echo $row_consulta_tres['strTitulo']; ?>"><?php echo $row_consulta_tres['strCategorias']; ?></a> 
           </div></div>
...
<table border="0">
  <tr>
    ...
    <td><?php if ($pageNum_consulta_tres > 0) { // Show if not first page ?>
       <li><a href="<?php printf("%s?pageNum_consulta_tres=%d%s", $currentPage, max(0, $pageNum_consulta_tres - 1), $queryString_consulta_tres); ?>">Anterior</a></li>
        <?php } // Show if not first page ?></td>
    <td><?php if ($pageNum_consulta_tres < $totalPages_consulta_tres) { // Show if not last page ?>
        <li><a href="<?php printf("%s?pageNum_consulta_tres=%d%s", $currentPage, min($totalPages_consulta_tres, $pageNum_consulta_tres + 1), $queryString_consulta_tres); ?>">Siguiente</a></li>
