...
mysql_select_db($database_mysql_noticias, $mysql_noticias);
$query_Recordset1 = sprintf("SELECT * FROM categorias WHERE categorias.idCategoria = %s", GetSQLValueString($varCategoria_Recordset1, "int"));
...
<div class="container">
  ...
  <div class="content"><!-- InstanceBeginEditable name="EditRegion3" -->
    <h1>Editar Categorias
      <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
        <table align="center">
          <tr valign="baseline">
            <td nowrap align="right">Titulo:</td>
            <td><input type="text" name="strTitulo" value="<?php echo $row_Recordset1['strTitulo']; ?>" size="32"></td>
          </tr>
          <tr valign="baseline">
            <td nowrap align="right">Seo:</td>
            <td><input type="text" name="srtSeo" value="<?php echo $row_Recordset1['srtSeo']; ?>" size="32"></td>
          </tr>
          <tr valign="baseline">
