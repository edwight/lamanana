...
mysql_select_db($database_mysql_noticias, $mysql_noticias);
$query_consulta_categoria = "SELECT * FROM categorias ORDER BY categorias.strTitulo";
$consulta_categoria = mysql_query($query_consulta_categoria, $mysql_noticias) or die(mysql_error());
    ...
    <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
      <table align="center">
        ...
        <tr valign="baseline">
          ...
          <td><textarea name="StrLeyenda" cols="50" rows="5"></textarea></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Posicion:</td>
          <td><select name="strPosicion">
            <option value="1" <?php if (!(strcmp(1, ""))) {echo "SELECTED";} ?>>uno</option>
            <option value="2" <?php if (!(strcmp(2, ""))) {echo "SELECTED";} ?>>dos</option>
            <option value="3" <?php if (!(strcmp(3, ""))) {echo "SELECTED";} ?>>tres</option>
          </select></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Fecha:</td>
          <td><input type="hidden" name="fecha" value="<?php date("d-m-Y H:i:s") ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Imagen:</td>
          <td><input type="text" name="strImagen" value="" size="32">
          <input type="button" name="button" id="button" value="subir imagen" onClick="javascript:subirimagen();"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Seo:</td>
          <td><input type="hidden" name="strSeo" value="Seo" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Categoria:</td>
          <td><label for="idCategoria"></label>
            <select name="idCategoria" id="idCategoria">
              <?php
do {  
?>
              <option value="<?php echo $row_consulta_categoria['idCategoria']?>"><?php echo $row_consulta_categoria['strTitulo']?></option>
              <?php
} while ($row_consulta_categoria = mysql_fetch_assoc($consulta_categoria));
  $rows = mysql_num_rows($consulta_categoria);
  if($rows > 0) {
      mysql_data_seek($consulta_categoria, 0);
	  $row_consulta_categoria = mysql_fetch_assoc($consulta_categoria);
  }
?>
          </select></td>
        ...
        <tr valign="baseline">
          ...
          <td><input type="text" name="strCategorias" value="" size="32"></td>
        </tr>
        <tr valign="baseline">
