...
<div class="container">
  ...
  <div class="content"><!-- InstanceBeginEditable name="EditRegion3" -->
    <h1>Bienvenidos administracion</h1>
    <p><a href="Entradas_add.php">Añadir Entradas</a></p>
    <table width="833" border="1">
      <tr>
        <td width="186">Titulo</td>
        <td width="187">Fecha</td>
        <td width="154">Acciones</td>
        <td width="278">ID</td>
      </tr>
      <?php do { ?>
  <tr>
    <td><?php echo $row_Recordset1['strTitulo']; ?></td>
    <td><?php echo $row_Recordset1['fecha']; ?></td>
    <td><a href="Entradas_Edicion.php?recordID=<?php echo $row_Recordset1['idEntradas']; ?>">Editar</a> - <a href="Entratas_eliminar.php?recordID=<?php echo $row_Recordset1['idEntradas']; ?>">Eliminar</a></td>
    <td><?php echo $row_Recordset1['idEntradas']; ?></td>
  </tr>
