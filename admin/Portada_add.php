...
if ((isset($_POST["enviado2"])) && ($_POST["enviado2"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO tblportadas (strPortadas, fecha) VALUES (%s, %s)",
                       GetSQLValueString($_POST['strPortadas'], "text"),
...
mysql_select_db($database_mysql_noticias, $mysql_noticias);
$query_Recordset1 = "SELECT * FROM tblportadas ORDER BY tblportadas.fecha DESC";
...
<div class="container">
  ...
  <div class="content"><!-- InstanceBeginEditable name="EditRegion3" -->
     <script>
  function subirimagen_portada(){
	  self.name = 'opener';
	  remote= open('gestionimagen_portada.php', 'remote', 'widt=400,height=150,scollbars=yes, menubars=no,toolbars=no,resizable=yes,fullscreen=yes,status=yes');
	  remote.focus();
	  }
    </script>
    <h1>Añadir Portada</h1>
    <p>&nbsp;</p>
    <form method="post" name="form2" id="form2" action="<?php echo $editFormAction; ?>">
      <table width="384" align="center">
        <tr valign="baseline">
          <td width="112" align="right" nowrap>StrPortadas:</td>
          <td width="260"><input type="text" name="strPortadas" value="<?php echo $row_Recordset1['strPortadas']; ?>" size="32">
          <input type="button" name="button" id="button" value="subir imagen" onClick="javascript:subirimagen_portada();"></td>
        </tr>
        <tr valign="baseline">
        ...
        <tr valign="baseline">
          ...
          <td><input type="submit" value="Insertar Portada"></td>
        </tr>
      </table>
