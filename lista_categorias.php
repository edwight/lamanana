...
$query_Recordset1 = "SELECT * FROM categorias ORDER BY categorias.strTitulo";
...
<div class="container">
  ...
  <div class="content"><!-- InstanceBeginEditable name="EditRegion3" -->
    ...
    <p><a href="categorias_add.php">Añadir Categorias</a></p>
    <table width="543" border="1">
      <tr>
        <td width="208">Categorias</td>
        <td width="319">ACIONES</td>
      </tr>
      <?php do { ?>
  <tr>
    <td><?php echo $row_Recordset1['strTitulo']; ?></td>
    <td><a href="categoria_edit.php?recordID=<?php echo $row_Recordset1['idCategoria']; ?>">Editar</a> - <a href="categoria_eliminar.php?recordID=<?php echo $row_Recordset1['idCategoria']; ?>">Eliminar</a></td> 
  </tr>
